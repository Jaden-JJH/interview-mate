...
const SECTIONS = [
  {
    title: "1. 수집하는 개인정보",
    body: [
      "이메일 주소: Clerk 인증 서비스를 통해 이메일·비밀번호 회원가입, 또는 소셜 로그인(카카오·Google·LinkedIn) 시 수집됩니다. 소셜 로그인 이용 시에는 해당 플랫폼의 계정 이메일 주소만 수집하며, 카카오의 경우 카카오 계정에 이메일이 등록·동의된 경우에만 수집됩니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "카카오 (소셜 로그인): 카카오 로그인 선택 시, 카카오계정 이메일 주소를 포함한 인증 정보를 처리합니다. kakao.com/policy/privacy",
  ...
  },
  {
    title: "5. 개인정보보호 책임자",
    body: [
      "개인정보 처리에 관한 업무를 총괄하고 관련 고충을 처리합니다.",
      "책임자 연락처: interviewmate2026@gmail.com",
      "정보주체는 언제든지 개인정보 열람·정정·삭제·처리정지를 요청할 수 있으며, 위 이메일로 요청하거나 마이페이지 → 회원 탈퇴를 통해 직접 처리할 수 있습니다.",
    ],
  },
  {
    title: "6. 개인정보 삭제 요청",
    body: [
      ...
      "또는 interviewmate2026@gmail.com 로 삭제를 요청할 수 있으며, 요청 접수 후 7영업일 이내에 처리됩니다.",
