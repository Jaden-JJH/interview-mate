...
const SECTIONS = [
  {
    title: "1. 서비스 소개",
    body: [
      "인터뷰메이트(이하 '서비스')는 Trust(이하 '운영자')가 AI 기술을 활용해 사용자 맞춤형 모의 면접 경험을 제공하는 웹 애플리케이션입니다.",
  ...
  },
  {
    ...
    body: [
      "신규 가입 회원에게는 무료 크레딧 1회가 제공되며, 이후 서비스 이용을 위해서는 크레딧을 구매해야 합니다.",
      "유료 크레딧은 Paddle을 통해 결제되며, 결제 후 14일 이내 사유 불문 전액 환불이 가능합니다.",
  ...
  },
  {
    title: "5. 약관 변경",
    body: [
      "운영자는 약관을 변경할 경우 시행 7일 이전부터 서비스 내 공지를 통해 알립니다. 이용자에게 불리한 중요 사항 변경 시에는 30일 이전에 이메일로도 고지합니다.",
      "변경된 약관에 동의하지 않는 경우 서비스 이용을 중단하고 탈퇴할 수 있습니다. 공지 후 계속 이용하면 변경 약관에 동의한 것으로 간주합니다.",
    ],
  },
  {
    title: "6. 준거법",
